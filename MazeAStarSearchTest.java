/*
 * Sam Polyakov
 * MazeAStarSearchTest.java
 * 04/23/2023
 * Project 7
 * CS231 B
 * 
 * Purpose: Tests A*S solver
 */

public class MazeAStarSearchTest {
    public static void testAStarSeach(MazeAStarSearch dfs, Maze maze, Cell start, Cell end) throws InterruptedException {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        MazeAStarSearch dfs = new MazeAStarSearch(maze);
        testAStarSeach(dfs, maze, start, end);
    }
}
