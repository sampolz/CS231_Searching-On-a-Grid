 ...
 * CS231 B
 * 
 * Purpose: Tests BFS solver
 */

 public class MazeBreadthFirstSearchTest {
    public static void testBreadthFirstSearch(MazeBreadthFirstSearch dfs, Maze maze, Cell start, Cell end) throws InterruptedException {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        MazeBreadthFirstSearch dfs = new MazeBreadthFirstSearch(maze);
        testBreadthFirstSearch(dfs, maze, start, end);
    }
}
